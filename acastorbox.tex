...
vThe samples were installed during June of 2015.  The samples were removed
and measurements were made on {\color{red} put dates here}.

\section{Tile designs}
\label{sec:design}

A total of six scintillators were tested.
...
One was made of SCSN-81, the blue-scintillating plastic used for most ofthe
CMS tiles by Kuraray.  One used EJ-200, a blue scintillator by
...
Also included were two tiles filled with liquid (EJ-309 from Eljen Technology).
Details on the tile can be found in~\cite{mdliquidtile}.
